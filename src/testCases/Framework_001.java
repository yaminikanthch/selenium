...
public class Framework_001{
	...
	public void main() throws Exception {
		...
		try{
			...
			//<Yamini>ProductSelect_Action.productType(iTestCaseRow);
			...
			//<Yamini>ProductSelect_Action.productNumber(iTestCaseRow);
			...
			//<Yamini>CheckOut_Action.Execute();
			...
			//<Yamini>PaymentDetails_Action.execute(iTestCaseRow);
